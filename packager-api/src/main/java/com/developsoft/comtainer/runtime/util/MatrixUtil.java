...
public class MatrixUtil {
	...
	private static LoadPlanStepRuntime findIntersection(final List<LoadPlanStepRuntime> steps, final int x, final int y, final int z, final int endX, final int endY, final int endZ) {
